 ...
 */
public class GoogleAnalyticsSendExperiments extends AbstractFilter implements ApplicationListener<ApplicationEvent> {

    private static Logger logger = LoggerFactory.getLogger(GoogleAnalyticsSendExperiments.class);
    ...
    public String execute(String previousOut, RenderContext renderContext, Resource resource, RenderChain chain) throws Exception {
        ...
        if (script != null) {
            String scriptUrl = renderContext.getURLGenerator().getContext() + "/modules/mf-google-analytics/javascript/wemga/google_experiments.js";
